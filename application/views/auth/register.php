...
<head>
    ...
    <link href="<?php echo get_theme_uri('custom/auth/register/css/bg.css'); ?>" rel="stylesheet" media="all">
...
<body>
    <div class="page-wrapper p-t-180 p-b-100 font-robo" style="background-color: #201f1f;"> 
            ...
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('auth/register/verify'); ?>
                        ...
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Penjual (1),Customer (2)" name="role_id" value="<?php echo set_value('role_id'); ?>" required>
                        ...
                        <div class="p-t-30">
                            <button class="btn btn--radiua" style="background: #23272B" type="submit">Daftar</button>
                        </div>
                    </form>
                </div>
            </div>
