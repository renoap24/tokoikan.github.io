...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/fish2.jpg'); ?>');">
    <div class="container">
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <div class="row justify-content-end">
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  ...
                  <p><button type="submit" class="btn btn-dark py-3 px-4">Checkout</button></p>
              </div>
          </div>
          </form>
          <?php else : ?>
