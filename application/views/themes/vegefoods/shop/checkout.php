...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/fish1.jpg'); ?>');">
    <div class="container">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-xl-5">
            <div class="row mt-5 pt-3">
                ...
                <input type="submit" class="btn btn-dark py-2 px-2" value="Buat Pesanan">
            </div>
                </div>
