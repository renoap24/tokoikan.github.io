...
<html lang="ID-id">
  <head>
    ...
    <link rel="icon" href="<?php echo base_url('assets/uploads/sites/logo1.png'); ?>" type="image/logo1">
  ...
  <aside class="main-sidebar sidebar-dark-dark elevation-4">
    ...
    <a href="<?php echo get_store_logo(); ?>" class="brand-link">
      <img src="<?php echo get_store_logo(); ?>" alt="<?php echo get_store_name(); ?> Logo1" class="brand-image img-circle elevation-3"
           style="opacity: .8">
